...
export const RoomTypeDeleteDialog = () => {
  ...
  const handleClose = () => {
    navigate('/room-type' + pageLocation.search);
  };
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="hotelApp.roomType.delete.question">
        <Translate contentKey="hotelApp.roomType.delete.question" interpolate={{ id: roomTypeEntity.id }}>
