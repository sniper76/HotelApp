  ...
  return (
    <div>
      <h2 id="voucher-heading" data-cy="VoucherHeading">
        <Translate contentKey="hotelApp.voucher.home.title">Vouchers</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="hotelApp.voucher.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/voucher/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="hotelApp.voucher.home.createLabel">Create new Voucher</Translate>
          </Link>
        </div>
      </h2>
        ...
        {voucherList && voucherList.length > 0 ? (
            ...
            <thead>
              <tr>
                <th className="hand" onClick={sort('id')}>
                  <Translate contentKey="hotelApp.voucher.id">ID</Translate> <FontAwesomeIcon icon={getSortIconByFieldName('id')} />
                </th>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="hotelApp.voucher.home.notFound">No Vouchers found</Translate>
            </div>
          )
        )}
      </div>
